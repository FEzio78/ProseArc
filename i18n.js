...
const I18N = {
  en: {
    ...
    'reader.bookmarks': '🔖 Bookmarks', 'reader.addMark': '+ Bookmark this spot',
    'reader.noMarks': 'No bookmarks yet.', 'reader.removeMark': 'Remove',
    'reader.marked': 'Bookmarked', 'reader.markExists': 'Already bookmarked',
    'reader.bilingual': 'Bilingual', 'reader.bilingualHint': 'Tap a paragraph to reveal the original.',
    'reader.notePh': 'Note on this paragraph…', 'reader.noteSave': 'Save', 'reader.noteDelete': 'Delete',
    'reader.pageInd': '{pct}% · page {page}/{pages}',
    ...
    'set.keys': 'API keys', 'set.keysNote': 'For cloud providers. Stored only on this device — never in projects or exports.',
    'set.apiKey': 'API key', 'set.keyPh': 'Enter API key', 'set.baseUrl': 'Base URL',
    'f.provider': 'Provider', 'f.providerKeyNote': "Set this provider's API key in Settings → API keys.",
    'prov.local': 'Local (LM Studio)', 'prov.anthropic': 'Claude (Anthropic)', 'prov.compatible': 'OpenAI‑compatible',
    ...
    'err.noKey': 'No API key set for this provider. Add it in Settings → API keys (or switch the provider in the Workspace).',
  ...
  ar: {
    ...
    'reader.bookmarks': '🔖 الإشارات', 'reader.addMark': '+ ضع إشارة هنا',
    'reader.noMarks': 'لا إشارات بعد.', 'reader.removeMark': 'إزالة',
    'reader.marked': 'تمت الإشارة', 'reader.markExists': 'موضوعة مسبقًا',
    'reader.bilingual': 'ثنائي اللغة', 'reader.bilingualHint': 'انقر فقرة لإظهار الأصل.',
    'reader.notePh': 'ملاحظة على هذه الفقرة…', 'reader.noteSave': 'حفظ', 'reader.noteDelete': 'حذف',
    'reader.pageInd': '{pct}٪ · صفحة {page}/{pages}',
    ...
    'set.keys': 'مفاتيح API', 'set.keysNote': 'لمزوّدي السحابة. تُخزَّن على هذا الجهاز فقط — لا في المشاريع ولا في الملفات المصدَّرة.',
    'set.apiKey': 'مفتاح API', 'set.keyPh': 'أدخل المفتاح', 'set.baseUrl': 'الرابط الأساسي',
    'f.provider': 'المزوّد', 'f.providerKeyNote': 'اضبط مفتاح هذا المزوّد في الإعدادات ← مفاتيح API.',
    'prov.local': 'محلي (LM Studio)', 'prov.anthropic': 'كلود (Anthropic)', 'prov.compatible': 'متوافق مع OpenAI',
    ...
    'err.noKey': 'لا يوجد مفتاح API لهذا المزوّد. أضِفه في الإعدادات ← مفاتيح API (أو غيّر المزوّد في مساحة العمل).',
